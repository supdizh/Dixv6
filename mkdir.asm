...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 6c 08 00 	movl   $0x86c,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	0f b6 80 cc 0a 00 00 	movzbl 0xacc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 57b:	75 27                	jne    5a4 <printf+0x11f>
          s = "(null)";
 57d:	c7 45 f4 88 08 00 00 	movl   $0x888,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64b:	a1 e8 0a 00 00       	mov    0xae8,%eax
...
free(void *ap)
{
 ...
 716:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 71b:	c9                   	leave  
 71c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 769:	e8 ce fe ff ff       	call   63c <free>
  return freep;
 76e:	a1 e8 0a 00 00       	mov    0xae8,%eax
}
 773:	c9                   	leave  
 774:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 787:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 78a:	a1 e8 0a 00 00       	mov    0xae8,%eax
 78f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 792:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 796:	75 23                	jne    7bb <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 798:	c7 45 f0 e0 0a 00 00 	movl   $0xae0,-0x10(%ebp)
 79f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a2:	a3 e8 0a 00 00       	mov    %eax,0xae8
 7a7:	a1 e8 0a 00 00       	mov    0xae8,%eax
 7ac:	a3 e0 0a 00 00       	mov    %eax,0xae0
    base.s.size = 0;
 7b1:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 7b8:	00 00 00 
  }
 ...
 80e:	a3 e8 0a 00 00       	mov    %eax,0xae8
      return (void*)(p + 1);
 ...
 819:	eb 38                	jmp    853 <malloc+0xde>
    ...
    if(p == freep)
 81b:	a1 e8 0a 00 00       	mov    0xae8,%eax
